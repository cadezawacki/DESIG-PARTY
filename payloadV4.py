...
class BaseMessage(Message):
    def __init__(self, action_str, action_int, *,
        ...
        if (toast is None) and _any([toastType, toastTitle, toastMessage]):
            ...
            toast = ToastData(toastType=toastType, title=toastTitle, message=toastMessage, toastId=toastId, options=toastOptions, link=kwargs.pop('link', None))
...
class MicroPublish:
    ...
    def to_dict(self) -> dict:
        ...
        if self.changelog:
            d["data"]["changelog"] = self.changelog
        return d
